    ...
    <div class="bg-black text-white min-h-screen flex flex-col">
        ...
        <footer class="bg-[#FF2D20] text-white p-6 text-center">
            ...
            >
                <div>
                    <iframe
                        src="https://yandex.ru/map-widget/v1/?ll=50.826198%2C61.677702&mode=poi&poi%5Bpoint%5D=50.825564%2C61.677677&poi%5Buri%5D=ymapsbm1%3A%2F%2Forg%3Foid%3D232821190503&z=18.6"
                        width="300"
                        height="200"
                        frameborder="0"
                        class="rounded-lg"
